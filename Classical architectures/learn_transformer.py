# follow the tutorial, https://youtu.be/U0s0f995w14
...
class SelfAttention(nn.Module):
    def __init__(self, embed_size, heads):
        ...
        self.heads = heads
        self.head_dim = embed_size // heads  # 8 heads, 256/8 = 32
...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, trg_vocab_size, src_pad_idx, trg_pad_idx, embed_size=256, num_layers=6,
                 forward_expansion=4, heads=8, dropout=0, device=torch.device("cpu"), max_length=100):
